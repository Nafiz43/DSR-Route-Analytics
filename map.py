...
if st.button("Add line"):
    ...
    if c > 0:
        ...
        st.sidebar.write(p1)
        st.sidebar.subheader("p2p:")
        st.sidebar.write(p2)
        st.sidebar.subheader("elapsed_time:")
        st.sidebar.write(p3)
        st.sidebar.subheader("elapsed_distance:")
        st.sidebar.write(p4)
...
if st.button("View Graph"):
        ...
        st.image(I1,width=700,caption="Distance vs Time")
if st.button("View BoxPlot"):
        st.subheader("BoxPlot")
        I2=Image.open("p2.png")
        st.image(I2,width=500,caption="BoxPlot")
